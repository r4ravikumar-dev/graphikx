...
function Hero() {
  return (
    <>
      ...
      <div class="w-full flex flex-wrap justify-center items-center text-lightBlue/80  mx-auto max-w-screen-lg">
          <b class="font-ubuntu text-[32px] lg:text-[64px] text-center leading-[135%]">
