  ...
  return (
    <>
      ...
      <img
        src={background}
        alt="Hero Background"
        className="w-full h-[100vh] blur-[2px] object-cover object-center absolute -z-10 top-0 left-0"
      />
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center ">
      <div class="w-full flex flex-wrap justify-center items-center text-white  mx-auto max-w-screen-lg">
          <b class="font-ubuntu text-[40px] lg:text-[64px] text-center leading-[135%]">
